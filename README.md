...
<h2>Versão Tkinter</h2>
  Para começo do projeto, foi criado uma versão do Tkinter para saber como seria a ideia modelada no digital. Tkinter é um framework padrão que está instalado na linguagem python, sendo        assim não tendo problema e dificuldades no desenvolvimento do projeto, essa versão já está finalizada e teve seu proposito concluído.</br>
  </br>
